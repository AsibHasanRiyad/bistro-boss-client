...
const AdminHome = () => {
  ...
  const pieChartsData = chartsData.map(chart => {
    return {name:chart.category, value:chart.revenue}
  })
  return (
    <div>
      <h1 className=" font-cinzel text-4xl font-semibold">
        <span>Hi, Welcome Back !</span>{" "}
        <span className=" text-[#D1A054]"> {user ? user.displayName : ""}</span>{" "}
      </h1>

      {/* dash board */}
      <div className=" grid grid-cols-4 gap-4 my-10">
        <div className="stat bg-gradient-to-r from-[#BB34F5] to-[#FCDBFF] text-white rounded px-8 py-5">
        ...
        <div className="stat bg-gradient-to-r from-[#D3A256] to-[#FDE8C0] text-white rounded px-8 py-5">
          <div className="stat-figure ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
          ...
          <div className="stat-title text-white text-center">Customers</div>
        </div>
        <div className="stat bg-gradient-to-r from-[#FE4880] to-[#FECDE9] text-white rounded px-8 py-5">
          <div className="stat-figure ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
          ...
          <div className="stat-title text-white text-center">Products</div>
        </div>
        <div className="stat bg-gradient-to-r from-[#6AAEFF] to-[#B6F7FF ] text-white rounded px-8 py-5">
          <div className="stat-figure ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
          ...
          <div className="stat-title text-white text-center">Orders</div>
        </div>
      </div>
      {/* charts */}
      <div className=" flex">
