      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        {reviews.map((review) => (
          <SwiperSlide key={review._id}>
            <div className=" px-10 md:px-28 py-8 md:py-12 text-center">
              ...
              <p className=" text-xs md:text-base py-5">{review.details}</p>
              <h1 className=" text-xl md:text-3xl text-[#CD9003]">
                {review.name}
              </h1>
            </div>
          </SwiperSlide>
